                                                    ...
                                                    <div class="widget-card-wrapper w-100">
                                                        ...
                                                        <div class="widget-info align-items-center">
                                                            ...
                                                            <div class="widget-icon">
                                                                <svg width="40px" height="40px" class="svg-icon" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                    <g id="Iconly/Light/Wallet" stroke="#ffffff" stroke-width="1.5" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                                                                        <g id="Wallet" transform="translate(2.500000, 3.000000)" stroke="#2f3238" stroke-width="1.5">
                                                        ...
                                                        <div class="transaction-table users-data-table">
                                                            <div class="table-responsive">
                                                                <table class="table mb-0 table-responsive-sm">
                                                                    ...
                                                                    <tbody>
                                                                        <tr data-toggle="modal" data-target="#walletTransactionHistoryModal">
                                                                            <td>1</td>
                                                                            <td>S-SAVE-0001</td>
                                                                            <td>
