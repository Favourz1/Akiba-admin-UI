                ...
                <!-- <div class="row">
                    <div class="col-12 mb-4">
                        <div class="text-right">
                            <a href="#" class="btn btn-sm btn-secondary shadow-0 font-size-14" style="min-width: 113px; padding: 8px 10px;" data-toggle="modal" data-target="#add-new-user"><i class="fa fa-plus pr-1"></i> New User</a>
                        </div>
                    </div>
                </div> -->
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-header d-flex align-items-start mb-3 pl-0">
                                    <h4 class="card-title">Users In The System</h4>
                                    ...
                                    <table class="table user-list" id="datatable-basic">
                                        <thead class="users-data-table-head-container">
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1">Wallet Balance (<span
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-muted">228,000</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted">456,290</td>
                                                <td class="text-muted">Female</td>
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        <a class="btn dropdown-toggle" id="more-option" href="#"
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted">590,700</td>
                                                <td class="text-muted">Male</td>
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        <a class="btn dropdown-toggle" id="more-option" href="#"
