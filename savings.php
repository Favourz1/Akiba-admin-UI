...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="content-body savings-content-body">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="row">
                                ...
                                <div class="row">
                                        ...
                                        <div class="widget-card flex-row">
                                            <div class="widget-card-wrapper w-100">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    <div class="widget-title standard-savings">Standard Savings</div>
                                                    <a href="savings-single.php"><i class="las la-arrow-right"></i></a>
                                                </div>
                                                <div class="widget-info align-items-center">
                                                    <div class="widget-info-desc">
                                                        <div class="widget-amount">
                                                            ...
                                                            <span class="widget-amount-num">5,000,000</span>
                                                        </div>
                                                        <div class="text-success font-size-12">123% <span><i class="las la-arrow-up"></i></span></div>
                                                    </div>
                                                    <div class="widget-icon"><svg width="40px" height="40px" viewBox="-6.4 -6.4 76.80 76.80" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#C893A4" fill="none" transform="matrix(1, 0, 0, 1, 0, 0)">

                                                            <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">

                                                                <rect x="-6.4" y="-6.4" width="76.80" height="76.80" rx="38.4" fill="#fbeff3" strokewidth="0" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="widget-card flex-row">
                                            <div class="widget-card-wrapper w-100">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    <div class="widget-title dollar-savings">Dollar Savings</div>
                                                    <a href="savings-single.php"><i class="las la-arrow-right"></i></a>
                                                </div>
                                                <div class="widget-info align-items-center">
                                                    <div class="widget-info-desc">
                                                        <div class="widget-amount">
                                                            <span>$</span>
                                                            <span class="widget-amount-num">675,000</span>
                                                        </div>
                                                        <div class="text-danger font-size-12">13% <span><i class="las la-arrow-down"></i></span></div>
                                                    </div>
                                                    <div class="widget-icon">
                                                        <svg width="40px" height="40px" viewBox="-6.4 -6.4 76.80 76.80" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#9299E2" fill="none" transform="matrix(1, 0, 0, 1, 0, 0)">

                                                            <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">

                                                                <rect x="-6.4" y="-6.4" width="76.80" height="76.80" rx="38.4" fill="#e5e8ff" strokewidth="0" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="widget-card flex-row">
                                            <div class="widget-card-wrapper w-100">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    <div class="widget-title target-savings">Target Savings</div>
                                                    <a href="savings-single.php"><i class="las la-arrow-right"></i></a>
                                                </div>
                                                <div class="widget-info align-items-center">
                                                    <div class="widget-info-desc">
                                                        <div class="widget-amount">
                                                            <span style="text-decoration-line: line-through; text-decoration-style: double;">N</span>
                                                            <span class="widget-amount-num">25,000,901</span>
                                                        </div>
                                                        <div class="text-success font-size-12">56% <span><i class="las la-arrow-up"></i></span></div>
                                                    </div>
                                                    <div class="widget-icon">
                                                        <svg width="40px" height="40px" viewBox="-6.4 -6.4 76.80 76.80" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#449958" fill="none" transform="matrix(1, 0, 0, 1, 0, 0)">

                                                            <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">

                                                                <rect x="-6.4" y="-6.4" width="76.80" height="76.80" rx="38.4" fill="#c5ecce" strokewidth="0" />
                                    ...
                                    <div class="col-lg-6">
                                        <div class="widget-card flex-row">
                                            <div class="widget-card-wrapper w-100">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    <div class="widget-title vault-savings">Vault Savings</div>
                                                    <a href="savings-single.php"><i class="las la-arrow-right"></i></a>
                                                </div>
                                                <div class="widget-info align-items-center">
                                                    <div class="widget-info-desc">
                                                        <div class="widget-amount">
                                                            <span style="text-decoration-line: line-through; text-decoration-style: double;">N</span>
                                                            <span class="widget-amount-num">64,030,120</span>
                                                        </div>
                                                        <div class="text-success font-size-12">150% <span><i class="las la-arrow-up"></i></span></div>
                                                    </div>
                                                    <div class="widget-icon">
                                                        <svg width="40px" height="40px" viewBox="-6.4 -6.4 76.80 76.80" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#FFA477" fill="none" transform="matrix(1, 0, 0, 1, 0, 0)">

                                                            <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">

                                                                <rect x="-6.4" y="-6.4" width="76.80" height="76.80" rx="38.4" fill="#fef3ec" strokewidth="0" />
                            ...
                            <div class="col-lg-5">
                                <div class="widget-card">
                                    <div class="card-body d-flex flex-column py-4">
                                        <div class="card-title text-center mb-3">Highest Yielding User</div>
                                        <div class="card-info row">
                                            <!-- <div class="col-lg-7 card-chart pl-0">
                                                <div class="position-relative">
                                                    <div id="highest-saving-user-chart"></div>
                                                </div>
                                            </div> -->
                                            <div class="col-lg-12 card-desc p-1 d-flex flex-column justify-content-center align-items-center">
                                                <a href="user-profile.php">
                                                    <div class="media d-flex flex-column justify-content-center align-items-center mb-3">
                                                        <img class="mb-3 rounded-circle mr-0" src="images/avatar-10.png" width="55" height="55" alt="">
                                                ...
                                                <!-- <div class="text-center font-weight-bold mb-3">
                                                    <span style="color:#8691b4;">Total Savings :</span> <span
                                                        class="font-size-16">
                                                        <span
                                                            style="text-decoration-line: line-through; text-decoration-style: double;">N</span>
                                                        670,000</span>
                                                </div> -->

                                                <ul class="highest-saving-user-list-wrapper  py-1 px-3  font-size-14 font-weight-semibold">
                                                    <li class="d-flex flex-column justify-content-between align-items-center mb-2">
                                                        <span>Standard Savings</span>
                                                        <span style="color: #5c6064;">180,000</span>
                                                    </li>
                                                    <li class="d-flex flex-column justify-content-between align-items-center mb-2">
                                                        <span>Dollar Savings</span>
                                                        <span style="color: #5c6064;">40,000</span>
                                                    </li>
                                                    <li class="d-flex flex-column justify-content-between align-items-center mb-2">
                                                        <span>Target Savings</span>
                                                        <span style="color: #5c6064;">50,000</span>
                                                    </li>
                                                    <li class="d-flex flex-column justify-content-between align-items-center mb-2">
                                                        <span>Vault Savings</span>
                                                        <span style="color: #5c6064;">400,000</span>
                                                    </li>
                                                </ul>
                                            </div>
                                                        ...
                                                        <table class="table mb-0 table-responsive-sm">
                                                            <thead class="users-data-table-head-container">
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 232.891px;">
                                                                        Category</th>
                                                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 185.062px;">Amount
                                                                    </th>
                                                                    <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 232.891px;">
                                                                        Transaction Type</th>
                                                                </tr>
                                                            ...
                                                            <tbody>
                                                                <tr data-toggle="modal" data-target="#transactionDetailsModal">
                                                                    ...
                                                                    <td>02-03-2023</td>
                                                                    <td><span class="badge badge-dollar-savings">Dollar
                                                                            Savings</span></td>
                                                                    <td>$20,000</td>
                                                                    <td>
                                                                ...
                                                                <tr data-toggle="modal" data-target="#transactionDetailsModal">
                                                                    ...
                                                                    <td>01-02-2023</td>
                                                                    <td>
                                                                        <span class="badge badge-standard-savings">
                                                                            Standard Savings</span>
                                                                    </td>
                                                                    <td>&#8358;1,850</td>
                                                                    <td>
                                                                ...
                                                                <tr data-toggle="modal" data-target="#transactionDetailsModal">
                                                                    ...
                                                                    <td>10-03-2023</td>
                                                                    <td><span class="badge badge-vault-savings">Vault
                                                                            Savings</span></td>
                                                                    <td>&#8358;15,280</td>
                                                                    <td>
                                                                        <span class="badge badge-success">Received</span>
                                                                ...
                                                                <tr data-toggle="modal" data-target="#transactionDetailsModal">
                                                                    ...
                                                                    <td>10-03-2023</td>
                                                                    <td><span class="badge badge-target-savings">Target
                                                                            Savings</span></td>
                                                                    <td>&#8358;200,000</td>
                                                                    <td>
                                                                        <span class="badge badge-danger">Withdrawn</span>
