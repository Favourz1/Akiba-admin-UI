                    ...
                    <div class="auth-form">
                        ...
                        <div class="form-container mb-5">
                            <div class="text-center mb-4 pb-1">
                                ...
                                <p class="login-subtext">Log in to your account. New to Akiba? <a class="text-link" href="signup.php">Sign up</a></p>
                            </div>
                            <form method="post" name="myform" class="" action="dashboard.php">
                                ...
                                <div class="login-button text-center">
                                    <a href="users.php" type="submit" class="btn btn-secondary btn-block">Log in</a>
                                </div>
                                <div class="forgot-password text-center mt-4">
                                    <p class="mb-0"><a class="text-link forgot-password--link" href="password-reset.php">Forgot password?</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
