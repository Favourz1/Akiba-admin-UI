                ...
                <div class="auth-content">
                    <div class="auth-form">
                        ...
                        <div class="text-center mb-4 pb-2">
                            ...
                            <p class="login-subtext">Already have an account? <a class="text-link" href="login.php">Log in</a></p>
                        </div>
                        <div class="form-container">
                            <form method="post" name="myform" class="" action="otp-verification.php">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-12">
                                        ...
                                        <div class="password-instruction"><span class="fa fa-info-circle pr-1"></span>Password must be 8 characters minimum, must contain one number minimum, one lowercase character and one uppercase character</div>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-secondary btn-block mt-2">Create account</button>
                                </div>
                            </form>
                        </div>
                    </div>
